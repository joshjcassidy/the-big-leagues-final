...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { minutesOfVideo: @sponsor.minutesOfVideo, participants: @sponsor.participants, placings: @sponsor.placings, streamHours: @sponsor.streamHours, tournaments: @sponsor.tournaments } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { minutesOfVideo: @sponsor.minutesOfVideo, participants: @sponsor.participants, placings: @sponsor.placings, streamHours: @sponsor.streamHours, tournaments: @sponsor.tournaments } }
